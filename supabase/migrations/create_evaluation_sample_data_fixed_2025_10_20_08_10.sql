    ...
    LOOP
        ...
        FOR week_num IN (current_week - 3)..(current_week) LOOP
            ...
            IF eval_id IS NOT NULL THEN
                ...
                -- 역할별 의견 샘플 생성 (간단한 버전)
                INSERT INTO public.role_opinions_2025_10_20_08_10 (evaluation_id, role_key, opinion_text) VALUES
                (eval_id, 'strategy_leader', '이번 주는 금리 인상 가능성에 집중했습니다. 은행주와 보험주에 대한 관심이 높아지고 있어 관련 종목들을 검토했습니다.'),
                (eval_id, 'researcher', '연준 의사록과 최근 경제지표를 분석했습니다. CPI 상승률이 예상보다 높게 나와 금리 인상 압박이 커지고 있습니다.'),
                (eval_id, 'analyzer', '팀 토론 결과 금융주 비중을 늘리기로 결정했습니다. 특히 KB금융과 신한지주에 관심을 두고 있습니다.'),
                (eval_id, 'risk_checker', '금리 인상이 예상보다 급격할 경우 성장주 타격이 클 수 있습니다. 포트폴리오 비중 조절이 필요합니다.');
